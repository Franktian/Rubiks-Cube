...
public class Cube {
	private Face a = new Face();
	private Face b = new Face();
	private Face c = new Face();
	private Face d = new Face();
	private Face e = new Face();
	...
	public void initialize(Face a, Face b, Face c, Face d, Face e, Face f){
		this.a = a;
		this.b = b;
		this.c = c;
		this.d = d;
